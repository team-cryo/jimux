...
impl Integer for u4
{
    ...
    const MAX: Self = Self::from(((1 << 4) - 1) as u8);
...
impl UnsignedInteger for u4
{

}

impl FalsePrimitive<u8> for u4
{
    fn prim(&self) -> u8
    {
        self.0 % (1 << 4)
